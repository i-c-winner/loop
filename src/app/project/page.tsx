...
import {options, sections} from "@/shared/assets/data/pipeData";
import {useRouter} from "next/navigation";
import {Box, Typography, List, ListItem, ListItemText, IconButton, Card, Stack} from "@mui/material";
    ...
    <Box sx={{
      ...
      >
        <Card sx={{
          ...
          <Typography variant={'h5'}>Открыть раздел рабочей документации</Typography>
          <List sx={{
            margin: "0 auto",
